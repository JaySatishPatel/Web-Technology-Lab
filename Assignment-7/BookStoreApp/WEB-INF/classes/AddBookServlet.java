...
public class AddBookServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (title == null || title.trim().isEmpty() || 
            ...
            out.println("<a href='addBook.html'>Go Back</a>");
            return;
        }
        ...
        try {
            ...
            if (result > 0) {
                ...
                out.println("<title>Book Added Successfully - BookStore</title>");
                ...
                out.println("      </div>");
                out.println("      <h2 class=\"card-title\" style=\"color: #2c3e50;\">Book Added Successfully!</h2>");
                out.println("      <p class=\"card-text text-muted\" style=\"font-size: 1.1rem; margin: 20px 0;\">");
                out.println("        \"<strong>" + escapeHtml(title) + "</strong>\" has been added to your inventory.");
                out.println("      </p>");
                ...
                out.println("          <i class=\"fas fa-plus\"></i> Add Another");
                out.println("        </a>");
                out.println("      </div>");
                out.println("    </div>");
                out.println("  </div>");
                ...
                out.println("<h3>Error: Could not add book!</h3>");
                out.println("<a href='addBook.html'>Go Back</a>");
